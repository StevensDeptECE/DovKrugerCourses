...
2. Download git. In msys2, this is
...
5. Apply your key.
   ...
   2. Log into github.com. Click on your id (top right)
   3. Click on your icon, settings:
   ...
   5. I suggest creating a directory for git, all your git repos can go under here. You can use any tool you like, I use mkdir:
